from utils.regression_trainer_GramFormer import RegTrainer, RegTrainer_FD
import argparse
import os
import torch
args = None
...
def parse_args():
    ...
    parser.add_argument('--model-name', default='FD_GramFormer', help='the name of the model')
    parser.add_argument('--data-dir', default="./data/DarkCrowd/",
                        help='training data directory')
    parser.add_argument('--save-dir', default='FD_GramFormer_DarkCrowd',
...
if __name__ == '__main__':
    ...
    if args.model_name == 'GramFormer':
        trainer = RegTrainer(args)
    elif args.model_name == 'FD_GramFormer':
